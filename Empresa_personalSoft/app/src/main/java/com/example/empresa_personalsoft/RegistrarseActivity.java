...
public class RegistrarseActivity extends AppCompatActivity implements Response.Listener<JSONObject>,Response.ErrorListener{
    ...
    public void Consultar(View view){
         ...
         if (usuario.isEmpty()){
            ...
            url = "http://172.16.59.28:80/WebServices/consulta.php?usr=" + usuario;
    ...
    public void Adicionar(View view){
        ...
        if (usuario.isEmpty() || nombre.isEmpty() || correo.isEmpty() || clave.isEmpty()){
            ...
            url = "http://172.16.59.28:80/WebServices/registrocorreo.php";
    ...
    public void Modificar(View view){
        ...
        if (usuario.isEmpty() || nombre.isEmpty() || correo.isEmpty() || clave.isEmpty()){
            ...
            jetusuario.requestFocus();
                ...
                url = "http://172.16.59.28:80/WebServices/actualiza.php";

            StringRequest postRequest = new StringRequest(Request.Method.POSTC, url,
                    new Response.Listener<String>()
                    {
                        @Override
                        public void onResponse(String response) {
                            Limpiar_campos();
                            Toast.makeText(getApplicationContext(), "Actualización de usuario realizada!", Toast.LENGTH_LONG).show();
                        }
                    },
                    new Response.ErrorListener()
                    {
                        @Override
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(getApplicationContext(), "Actualiazción de usuario incorrecto!", Toast.LENGTH_LONG).show();
                        }
                    }
            ) {
                @Override
    ...
    public void Anular(View view){
            ...
            if (usuario.isEmpty()){
                ...
                url = "http://172.16.59.28:80/WebServices/anula.php";
                StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                        new Response.Listener<String>() {
                            @Override
                            public void onResponse(String response) {
